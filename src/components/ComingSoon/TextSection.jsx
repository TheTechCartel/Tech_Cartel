...
import InputCmpt from '../shared/InputCmpt'
    ...
    <div className='flex flex-col space-y-[2em]'>
        ...
        <div>
            ...
            <div className='flex flex-row w-[20em] my-[.5em]'>
                ...
                <InputCmpt type='text' addedClasses=' bg-secondary placeholder:text-[#6D6D6D] border-[1px]  border-[#6D6D6D]' placeholder = {'Enter your email address'} />
